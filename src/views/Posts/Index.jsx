...
export default function PostIndex() {
  //title page
  document.title = "Post - NewsApp Administartor";
  ...
  const fetchData = async (keywords = "", page = 0) => {
    await Api.get(
      `/api/v1/post/list/ACTIVE${keywords ? `?string_filter=${keywords}` : ""}${
        keywords ? "&" : "?"
      }page=${page}`,
      {
        //header
      ...
      buttons: [
        {
          label: "YES",
          onClick: async () => {
            await Api.delete(`/api/v1/post/${id}`, {
              //header
              headers: {
                //header Bearer + Token
                Authorization: `Bearer ${token}`,
        ...
        <div className="row align-items-center mb-3">
          ...
          <div className="col-md-9 col-12 mb-2">
            <div className="input-group" style={{ width: "100%" }}>
              ...
              />
              <span
                className="input-group-text border-0 shadow bg-white"
                          ...
                          post.map((posts, index) => (
                            <tr key={index}>
                              ...
                              <td className="text-center">
                                <img src={posts.image} width="70" />
                              </td>
                              <td>{posts.created_date}</td>
                              <td className="text-center">
                                <Link
                                  to={`/post/edit/${posts.id}`}

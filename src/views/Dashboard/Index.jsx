...
export default function Dashboard() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setCountCategories(dashboardData.categories);
            setCountPosts(dashboardData.posts);
            setCountUsers(dashboardData.users);
            setDays(dashboardData.post_views.days);
            setCount(dashboardData.post_views.count);
        } catch (error) {
